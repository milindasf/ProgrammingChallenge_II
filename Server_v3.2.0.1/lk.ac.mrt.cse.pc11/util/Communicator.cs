...
namespace lk.ac.mrt.cse.pc11.util
{
    ...
    class Communicator
    {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (connection.Connected)
                    {
                        ...
                        try
                        {
                            Console.WriteLine("*****______****** " + reply);
                           // Console.WriteLine("____reply:" + reply.ToCharArray()[reply.Length - 1]);
                           // Console.WriteLine(reply.IndexOf(reply.ToCharArray()[reply.Length - 1]));
                        ...
                        dataObj = new DataObject(reply, ip, port);
        ...
        public void SendData(object stateInfo)
        {
            ...
            try
            {
                if (dataObj.ClientPort==Constant.CLIENT_PORT)
                {
